import useAutorForm from "../hooks/useAutoresForm";

export default function AutorForm({ isOpen, reloadAutores, setIsOpen }) {
  const { formData, handleChange, handleSubmit } = useAutorForm({
    isOpen,
    reloadAutores,
    setIsOpen,
  });
